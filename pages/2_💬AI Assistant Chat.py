...
with st.spinner("Initiating the AI assistant. Please hold..."):
    ...
    Watsonx_API = "3juETlPr9zomht4DoZSOjlirstd0XD6ixOaMlVNquygU"
    Project_id= "6046e4ad-6889-485f-b309-fcfd86eb6350"
...
def ask_bot(user_query):
    ...
    Your goal is to support him in presenting {pronoun}self effectively to potential employers and promoting {pronoun} candidacy for job opportunities.
